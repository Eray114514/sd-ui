...
export function ControlPanel() {
  ...
  return (
    <>
      <div className="fixed bottom-0 left-0 lg:left-[80px] right-0 z-40 px-4 pb-[calc(1rem+env(safe-area-inset-bottom))] lg:pb-4 transition-all duration-300 pointer-events-none flex flex-col items-center">
